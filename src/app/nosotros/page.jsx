export default function Nosotros() {
  return (
    <section className="p-10 max-w-5xl mx-auto animate-fadeIn duration-500 ease-out text-justify text-xl">
      ...
      <h2 className="text-3xl font-bold mb-4 text-green-500 mt-10">Nuestra Misión</h2>
      <p className="text-gray-300 leading-relaxed mb-4">
        Transformar el plástico descartado en nuevas oportunidades, reduciendo
        el impacto ambiental y promoviendo una cultura de reciclaje consciente
        en nuestra comunidad..
      </p>
      <h2 className="text-3xl font-bold mb-4 text-green-500 mt-10">Nuestra Visión</h2>
      <p className="text-gray-300 leading-relaxed mb-4">
        Ser referentes en reciclaje de plásticos a nivel regional, impulsando
        soluciones sostenibles que integren tecnología, educación ambiental y
        responsabilidad social.
      </p>
      <h2 className="text-3xl font-bold mb-4 text-green-500 mt-10">
        Nuestros Valores
      </h2>
      <p className="text-gray-300 leading-relaxed mb-4">
        🌱 Compromiso ambiental Trabajamos cada día con la convicción de
        proteger el entorno que compartimos.
      </p>
      <p className="text-gray-300 leading-relaxed mb-4">
        ♻️ Economía circular Creemos en el ciclo de vida continuo de los
      ...
      <p className="text-gray-300 leading-relaxed mb-4">
        💡 Innovación con propósito Buscamos soluciones creativas y eficientes
        que generen impacto positivo en el medioambiente y en la sociedad.
      </p>
      <p className="text-gray-300 leading-relaxed mb-4">
        🧠 Educación y conciencia Apostamos a la formación y sensibilización
        como herramientas clave para construir una cultura más responsable y
        ecológica.
      </p>
    </section>
  );
